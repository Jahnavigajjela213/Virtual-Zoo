...
// Function to Describe ZooPedia Page
function describeZooPediaPage() {
    const description = `
        Welcome to ZooPedia! Here you can learn fascinating facts about various animals.
        You can navigate to other sections such as Animal Tales, Games, Explore Forest, 
...
function processQuery(query) {
    ...
    // Specific Page Navigation for ZooPedia
    ...
    // Describe ZooPedia Page
    else if (query.includes("describe zoopedia") || query.includes("tell me about this page")) {
        describeZooPediaPage();
    }
    // Fallback Response
    else {
